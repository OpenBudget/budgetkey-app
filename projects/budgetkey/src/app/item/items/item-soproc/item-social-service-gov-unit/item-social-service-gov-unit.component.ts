...
export class ItemSocialServiceGovUnitComponent implements OnInit, AfterViewInit {
  ...
  readonly MEASUREMENT_PRINCIPLES = [
    {n: 1, ordinal: 'ראשון', label: 'מקבלי השירות במרכז', side: 'top',
     definition: 'השירות מספק מענה מותאם ומיטבי לצרכי קהל היעד על גווניו ונותן להם קול בעיצובו'},
    {n: 2, ordinal: 'שני', label: 'ניהול מוכוון תוצאות', side: 'right',
     definition: 'השירות מבצע תהליכי למידה ושיפור מבוססי נתונים על מנת להשיג את תוצאותיו'},
    {n: 3, ordinal: 'שלישי', label: 'חדשנות וגמישות', side: 'right',
     definition: 'השירות מיישם את חזית הידע, ומתעדכן בהתאם לצרכי השעה'},
    {n: 4, ordinal: 'רביעי', label: 'פיתוח ושימור ידע', side: 'bottom',
     definition: 'הידע הנצבר במהלך ההתקשרות מתועד, משותף ומזין קבלת החלטות'},
    {n: 5, ordinal: 'חמישי', label: 'המפעיל כשותף', side: 'left',
     definition: 'היחסים עם המפעיל מבוססים על אמון ומחויבות משותפת למתן שירות איכותי'},
    {n: 6, ordinal: 'שישי', label: 'תכנון כלכלי ותחרות', side: 'left',
     definition: 'התכנון הכלכלי ומודל התיחור והתמורה מתמרצים את המפעיל לתת שירות איכותי ויעיל במסגרת התקציב'},
  ];
