...
- תקציב המדינה כולל ביצוע מתוך [אתר משרד האוצר](https://www.gov.il/he/pages/tableau).
- נתוני העברות תקציביות מתוך [אתר משרד האוצר)](https://www.gov.il/he/pages/budget-changes-current-year).
- נתונים על תמיכות מתוך [פורטל התמיכות של משרד האוצר](https://tmichot.mof.gov.il/).
- נתונים בנוגע לתהליכי רכש ואישורם (מכרזים מרכזיים, מכרזים משרדיים ופטור ממכרז) לפני ביצוע ההתקשרות בפועל, מתבסס על הנתונים המוצגים מתוך [אתר הרכש הממשלתי](https://mr.gov.il/ilgstorefront/he).
