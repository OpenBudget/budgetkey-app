...
```plotly
{
  "data": [{
    "type": "bar",
    "x": [1997, 2000, 2003, 2006, 2009, 2012, 2015, 2018, 2021, 2024, 2026],
    "y": [10252, 11998, 13772, 15374, 17005, 20896, 27880, 35518, 58577, 57521, 64361],
    "marker": { "color": "#FF5A5F" },
    "hovertemplate": "%{x}: %{y:,} מלש\"ח<extra></extra>"
  }],
  "layout": {
    "title": "תקציב משרד הבריאות המתוקן, 1997-2026 (מיליארדי ש\"ח)",
    "xaxis": { "title": "שנה" },
    "yaxis": { "title": "תקציב מתוקן (מלש\"ח)" }
  },
...
```plotly
{
  "data": [{
    "type": "pie",
    "labels": ["קופות חולים ובתי חולים (24.20)", "רכש שירותי בריאות (24.07)", "משרד ראשי (24.02)", "שירותי בריאות הציבור (24.16)", "מרכזים לבריאות הנפש (24.40)"],
    "values": [52621472000, 7659906000, 2059517000, 1979559000, 40858000],
    "marker": { "colors": ["#FF5A5F", "#6D82B4", "#3C4B7C", "#9CD3FE", "#495A8F"] },
    "textinfo": "percent",
    "hovertemplate": "%{label}: %{value:,} ש\"ח (%{percent})<extra></extra>"
  }],
  "layout": {
    "title": "התפלגות תקציב משרד הבריאות 2026 לפי תחום (ש\"ח, מתוקן)"
  },
  "config": { "displayModeBar": false }
}
```
