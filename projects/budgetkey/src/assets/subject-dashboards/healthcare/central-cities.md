...
```plotly
{
  "data": [{
    "type": "pie",
    "labels": ["תל אביב-יפו", "רמלה", "הרצליה", "חולון", "רעננה", "בני ברק", "פתח תקווה", "רמת גן", "בת ים", "ראשון לציון", "רחובות", "לוד", "כפר סבא", "גבעתיים", "קריית אונו"],
    "values": [277517058, 34512895, 28161470, 25163637, 22992024, 19928722, 18525821, 15150855, 6955064, 3132758, 2441514, 2303670, 1412000, 371753, 158911],
    "textinfo": "percent",
    "hovertemplate": "%{label}: %{value:,} ₪ (%{percent})<extra></extra>"
  }],
  "layout": {
    "title": "ביצוע תקציב בריאות מצטבר לפי עיר מרכזית (₪)"
  },
